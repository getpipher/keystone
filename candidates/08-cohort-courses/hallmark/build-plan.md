...
- [x] **Step 1: File set + wiring + hygiene**
...
- [x] **Step 2: Token discipline (literal colours outside `:root`)**
...
- [x] **Step 3: Design-doc spot-checks**
...
- [x] **Step 1: Render into the throwaway dir**
...
- [x] **Step 1: Hash continuity + commit-absence**
...
- [x] **Step 1: Commit (no AI attribution)**
