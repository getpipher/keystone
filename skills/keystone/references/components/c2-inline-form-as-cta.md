...
**Gates:** G39 (input field states — border-width constant, focus via `outline`, input height = button height, disabled via 3 channels), G26 (submit button needs all 4 states).
