...
**Gates:** G43 (AI footer fingerprint — Ft3 is the default AI footer shape; reach for it only on a genuine hub/docs-root with a real sitemap, never reflexively), G49 (link labels stay single-line at all viewports), G52 (section-head grid collapses to 1fr at 48rem).
