...
*Don't confuse with:* T4 Numbered stat strip (several stats in a row, not one focal).
...
**Gates:** G46 (invented metrics — the number must be real, defensible, externally-verifiable).
