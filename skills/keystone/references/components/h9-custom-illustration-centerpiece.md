...
A single hand-built SVG (Tier B) or pure-CSS (Tier A for simpler shapes) sitting on the hero as one illustrative element. The bakery loaf, the studio's mascot, the workflow diagram.
...
The illustration itself is *built*, not picked from Storyset / Humaaans / unDraw / Lottie. See `custom-craft.md` for full recipes. Sketch below is the page-level structural shape.
