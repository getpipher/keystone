...
- **Heading:** small caption near a corner of the image; never centred display.
...
**Gates that police this macro:** G45 (decorative without purpose — images must be motivated, not ornamental), G34 (horizontal scroll — full-bleed images need `overflow-x: clip`).

Reference: Aimé Leon Dore, Mr Porter editorial, Stüssy lookbooks.

**Sample opening lines** (imitate the specificity — captions are dates, places, plate numbers, not marketing):
> *"Plate 47 · scored before the proof."* — a number, a moment in the process
> *"Spring, 2026."* — two words, full stop
