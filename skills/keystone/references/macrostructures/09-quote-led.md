...
- **Heading:** italic display setting a customer's quote (36–60px), with attribution below in small caps.
- **Body:** continues with additional testimonials, case studies, or a quiet feature list.
- **Divider:** centred quote-mark glyph or an em-rule between testimonials.
...
**Gates that police this macro:** G19 (placeholder names — testimonials must have real names + roles, never "Jane Doe"), G38a (no italic headers — the quote is italic body display, not a heading; use a blockquote, not an h1).
...
> *"I started listening on a long bus ride. By the third episode I'd missed my stop, and I didn't mind."* — story-shaped, attributed to a listener
> *"Restraint, repeated, becomes a signature."* — Keystone Atelier — short, philosophical, signed by the studio
> *"It told me the span that regressed, the deploy that caused it, and the engineer to ask. We rolled back in eight minutes."* — names the outcome with a number
