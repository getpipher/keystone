...
- **Heading:** large numbered stage labels (`1.0 INTAKE`, `2.0 PLAN`) — stacked above the stage content, not beside it.
...
**Gates that police this macro:** G54 (tag-left/heading-right — stage labels stack above content, never beside), G27 (reduced-motion fallback for horizontal sweep), G14 (animating layout properties — sweep uses transform, not width/margin).
...
> *"1.0 · parse · 2.0 · filter · 3.0 · route."* — versioned numbers, three concrete verbs
> *"I. We design products that last twelve years. II. A material is sustainable when someone, somewhere, can repair it."* — Roman numerals + declarative

```html
<section class="stage">
  <p class="stage-num">1.0 INTAKE</p>
  <p class="stage-desc">…</p>
  <figure><img src="stage-1.png" /></figure>
</section>
