...
**Gates that police this macro:** G33 (decorative SVG without aria — diagram nodes carrying information need `aria-label`; decorative edges need `aria-hidden="true"`), G34 (horizontal scroll — large diagrams need `overflow-x: clip`).
...
<section class="map">
  <svg class="diagram">
    <g class="node"><rect /><text>API</text></g>
    <g class="node"><rect /><text>Database</text></g>
    <line class="edge" x1="…" y1="…" x2="…" y2="…" />
  </svg>
  <p class="legend">Solid lines = sync · dashed = async</p>
</section>
```
