...
**Gates that police this macro:** G16 (celebratory success toast — "Copy" must be silent, no toast on successful copy), G26 (missing interaction states — every interactive preview needs `:hover`, `:focus-visible`, `:active`, `:disabled`).
...
<section class="playground">
  <h2>Buttons</h2>
  <div class="example">
    <div class="preview"><button class="btn">Primary</button></div>
    <pre class="code"><code>&lt;button class="btn"&gt;Primary&lt;/button&gt;</code></pre>
