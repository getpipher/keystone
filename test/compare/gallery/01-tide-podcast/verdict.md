...
| Hallmark | **42/48 (rows 41/57)** | G18, G20, G26, G40, G51, G54 |

**Winner by engine score: keystone (+6 gates).** The blind G44 FAIL on the Hallmark
side (dead band + clipped lede) converges with the engine's contrast/structure
findings — independent methods, same verdict.
